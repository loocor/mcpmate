export const marketTranslations = {
    en: {
		...
		detail: {
			...
			installedValue: "Installed in MCPMate",
			notInstalledValue: "Not installed yet",
			type: "Type",
			noDescription: "No description provided.",
			notFoundTitle: "Registry entry not found",
			readme: "README",
    ...
    "zh-CN": {
		...
		detail: {
			...
			repository: "代码仓库",
			installation: "安装状态",
			installedValue: "已在 MCPMate 中安装",
			notInstalledValue: "尚未安装",
			type: "类型",
			noDescription: "暂无描述。",
			notFoundTitle: "未找到注册表条目",
			readme: "README",
    ...
    "ja-JP": {
		...
		detail: {
			...
			website: "Webサイト",
			repository: "リポジトリ",
			installation: "インストール状態",
			installedValue: "MCPMate にインストール済み",
			notInstalledValue: "未インストール",
			type: "タイプ",
			noDescription: "説明はありません。",
			notFoundTitle: "レジストリエントリが見つかりません",
			readme: "README",
