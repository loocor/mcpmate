export const settingsTranslations = {
  en: {
    ...
    providers: {
      title: "LLM Providers",
      description: "Configure LLM providers for LLM-powered workflows",
      add: "Add Provider",
      cancel: "Cancel",
      create: "Create",
      delete: "Delete",
      edit: "Edit",
      save: "Save",
      empty: "No providers configured yet. Add an LLM provider to enable LLM-powered workflows.",
      ...
      dialogDescription: "Configure an LLM provider for provider-backed LLM workflows",
      originName: "LLM Provider",
      name: "Name",
      ...
      thinkingBudgetRequired: "Budget tokens must be positive and leave at least 1000 tokens for output.",
      providerTypes: {
      ...
      thinkingModes: {
        default: {
          ...
          description: "Do not send a thinking control field.",
        },
        disabled: {
          label: "Disabled",
          description: 'Send Anthropic thinking: { type: "disabled" }.',
        },
        enabled: {
          label: "Enabled",
          description: 'Send Anthropic thinking: { type: "enabled", budget_tokens }.',
        },
      },
    },
  },
  "zh-CN": {
    ...
    providers: {
      title: "LLM 供应商",
      description: "配置 LLM 供应商以启用 LLM 驱动的工作流",
      add: "添加供应商",
      cancel: "取消",
      create: "创建",
      delete: "删除",
      edit: "编辑",
      save: "保存",
      empty: "尚未配置供应商。添加 LLM 供应商以启用 LLM 驱动的工作流。",
      addFirst: "添加首个供应商",
      confirmDelete: "确定删除此供应商？",
      noKey: "无 API Key",
      testConnection: "测试连接",
      testFailed: "供应商测试失败",
      connected: "已连接",
      ...
      editTitle: "编辑供应商",
      addTitle: "添加供应商",
      dialogDescription: "配置 LLM 供应商以启用供应商支持的 LLM 工作流",
      originName: "LLM 供应商",
      name: "名称",
      ...
      thinkingBudgetRequired: "预算 Token 必须为正数，并至少为输出保留 1000 Token。",
      providerTypes: {
        openaiChat: "OpenAI Chat Completions",
        anthropic: "Anthropic Messages",
      },
      ...
      thinkingModes: {
        default: {
          label: "供应商默认",
          description: "不发送 thinking 控制字段。",
        },
        disabled: {
          label: "禁用",
          description: '发送 Anthropic thinking: { type: "disabled" }。',
        },
        enabled: {
          label: "启用",
          description: '发送 Anthropic thinking: { type: "enabled", budget_tokens }。',
        },
      },
    },
  },
  "ja-JP": {
    ...
    providers: {
      title: "LLM プロバイダー",
      description: "LLM 活用ワークフロー向けの LLM プロバイダーを設定",
      add: "プロバイダーを追加",
      cancel: "キャンセル",
      create: "作成",
      delete: "削除",
      edit: "編集",
      save: "保存",
      empty: "プロバイダーがまだ設定されていません。LLM プロバイダーを追加して LLM 活用ワークフローを有効にします。",
      addFirst: "最初のプロバイダーを追加",
      confirmDelete: "このプロバイダーを削除しますか？",
      noKey: "API Key なし",
      testConnection: "接続テスト",
      testFailed: "プロバイダーのテストに失敗しました",
      connected: "接続済み",
      failed: "失敗",
      default: "既定",
      setDefault: "既定に設定",
      editTitle: "プロバイダーを編集",
      addTitle: "プロバイダーを追加",
      dialogDescription: "プロバイダー連携の LLM ワークフロー向けに LLM プロバイダーを設定",
      originName: "LLM プロバイダー",
      name: "名前",
      namePlaceholder: "自分の OpenAI プロバイダー",
      type: "API タイプ",
      baseUrl: "ベース URL",
      apiKey: "API Key",
      apiKeyEditPlaceholder: "空にすると現在のキーを保持",
      model: "モデル",
      loadModels: "読み込み",
      selectModel: "モデルを選択",
      fetchModels: "モデルを取得",
      ...
      thinkingBudgetRequired: "予算トークンは正の値で、出力用に少なくとも 1000 トークンを残してください。",
      providerTypes: {
        openaiChat: "OpenAI Chat Completions",
        anthropic: "Anthropic Messages",
      },
      ...
      thinkingModes: {
        default: {
          label: "プロバイダー既定",
          description: "thinking 制御フィールドを送信しません。",
        },
        disabled: {
          label: "無効",
          description: 'Anthropic thinking: { type: "disabled" } を送信します。',
        },
        enabled: {
          label: "有効",
          description: 'Anthropic thinking: { type: "enabled", budget_tokens } を送信します。',
        },
      },
    },
  },
