export const settingsTranslations = {
  en: {
    ...
    providers: {
      title: "LLM Providers",
      description: "Configure AI providers for intelligent test generation and analysis",
      add: "Add Provider",
      empty: "No providers configured yet. Add an LLM provider to enable intelligent test generation.",
      ...
      dialogDescription: "Configure an LLM provider for intelligent test generation",
      name: "Name",
  ...
  "zh-CN": {
    ...
    providers: {
      title: "LLM 供应商",
      description: "配置 AI 供应商以启用智能测试生成和分析",
      add: "添加供应商",
      empty: "尚未配置供应商。添加 LLM 供应商以启用智能测试生成。",
      addFirst: "添加首个供应商",
      ...
      editTitle: "编辑供应商",
      addTitle: "添加供应商",
      dialogDescription: "配置 LLM 供应商以启用智能测试生成",
      name: "名称",
  ...
  "ja-JP": {
    ...
    providers: {
      title: "LLM プロバイダー",
      description: "インテリジェントなテスト生成と分析のために AI プロバイダーを設定",
      add: "プロバイダーを追加",
      empty: "プロバイダーがまだ設定されていません。LLM プロバイダーを追加してインテリジェントなテスト生成を有効にします。",
      ...
      editTitle: "プロバイダーを編集",
      addTitle: "プロバイダーを追加",
      dialogDescription: "インテリジェントなテスト生成のために LLM プロバイダーを設定",
      name: "名前",
      namePlaceholder: "My OpenAI Provider",
      type: "API タイプ",
      baseUrl: "ベース URL",
