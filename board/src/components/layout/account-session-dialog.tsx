		...
		>
			...
			<DialogContent
				className={cn(
					...
					"border-slate-200 bg-background shadow-xl dark:border-slate-800",
				)}
			>
				...
				<div className="border-t border-slate-200 bg-slate-50/80 px-6 py-4 dark:border-slate-800 dark:bg-slate-950/40 sm:px-8">
