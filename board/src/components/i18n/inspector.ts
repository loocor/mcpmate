export const inspectorTranslations = {
	en: {
		...
		modes: {
			...
			readTemplate: "Read Resource Template",
		},
		form: {
			mode: "Mode",
			native: "Native",
		...
		actions: {
			...
			read: "Read",
			running: "Running...",
			changeOperation: "Change Inspector operation",
			cancel: "Cancel",
	...
	"ja-JP": {
		...
		actions: {
			...
			read: "読み取る",
			running: "実行中...",
			changeOperation: "インスペクター操作を切り替える",
			cancel: "キャンセル",
			cancelling: "キャンセル中...",
		},
		proxy: {
