...
export default function UniImport() {
	return (
		...
		>
			...
			<H2>上流 HTTP サーバー向け OAuth</H2>
			<P>
				インポート対象の Streamable HTTP サーバーが OAuth を必要とする場合、Uni-Import は最初のステップ内で認証設定を行い、コールバックベースの認可フローを開始します。MCPMate がメタデータを自動準備してプロバイダーのログインを開き、認可後にプレビュー/インポートへ進みます。
			</P>
