	...
	return (
		...
		>
			...
			<Ul>
				...
				<Li>
					MCPMate からのインプレースプロファイル切り替えを有効にするには、クライアントを<strong>Hosted</strong> モードに設定します。ダッシュボード側のプロファイル切り替えではなく、セッション内の内蔵制御を使いたい場合は <strong>Unify</strong> モードを選びます。<strong>トランスペアレントモード</strong> は構成ファイルを書き込むのみで、プロファイルをリアルタイムに切り替えることはできません。
				</Li>
