...
export default function ClientApps() {
	return (
		...
		>
			...
			<H2>Discovery プリセットからクライアントを追加</H2>
			<P>
				New / Edit ドロワーでは Public Discovery の対応クライアント項目を読み込めます。プリセットを選ぶと、既知の識別子、表示名、アイコン、ホームページ、MCP 設定先から始められ、保存前にロールアウトモードを確認できます。
			</P>
			<Ul>
				<Li>初回オンボーディングで、対応済み AI アプリをすばやく追加する流れに使えます。</Li>
				<Li>ユーザー定義クライアントも、標準の MCP 設定場所を同じドロワーで指定できます。</Li>
				<Li>保存後は、検出済みデスクトップアプリと同じガバナンス制御でクライアント一覧に表示されます。</Li>
			</Ul>
