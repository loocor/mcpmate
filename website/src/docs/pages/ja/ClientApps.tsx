	...
	return (
		...
		>
			...
			<Ul>
				...
				<Li>
					<strong>設定</strong>は、ホストモードと透過モードの違い、能力ソース、適用フロー、およびインポートプレビューについて説明します。
				</Li>
				<Li>
			...
			<Ul>
				...
				<Li>
					<strong>設定</strong> &mdash; MCPMateがこのクライアント用に書き込むMCPサーバーのライブビュー、クライアントからのインポートフロー、およびホストモード対透過モードのヒント。
				</Li>
				<Li>
