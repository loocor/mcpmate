...
use crate::{
    api::{
        handlers::ApiError,
        models::audit::{AuditListData, AuditListReq, AuditListResp, AuditPolicyData, AuditPolicyResp, AuditPolicySetReq},
        routes::AppState,
    },
...
mod tests {
	...
	async fn test_state() -> Arc<AppState> {
		...
		Arc::new(AppState {
			connection_pool: Arc::new(Mutex::new(UpstreamConnectionPool::new(Arc::new(Config::default()), None))),
