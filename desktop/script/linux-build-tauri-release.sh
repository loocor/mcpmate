...
Examples:
  script/linux-build-tauri-release.sh
  script/linux-build-tauri-release.sh --target x86_64-unknown-linux-gnu --bundles appimage,deb
  script/linux-build-tauri-release.sh --profile debug --skip-board
