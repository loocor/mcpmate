...
Examples:
  ...
  packaging/desktop/windows-build-tauri-release.sh --target x86_64-pc-windows-msvc --bundles msi
  packaging/desktop/windows-build-tauri-release.sh --profile debug --skip-board
