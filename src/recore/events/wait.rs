//! Event waiting utilities for the recore event system
...
use crate::{
    ...
    recore::{
        foundation::error::{RecoreError, RecoreResult},
...
///
/// # Returns
/// * `RecoreResult<()>` - Success or timeout error
        ...
        loop {
            match rx.recv().await {
                ...
                Err(e) => {
                    ...
                    return Err(RecoreError::generic_error(
