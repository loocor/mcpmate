//! Recore Error Types
//!
//! unified error handling module, providing error type definitions for the entire recore system

use thiserror::Error;

/// unified error type for the recore system
#[derive(Error, Debug)]
pub enum RecoreError {
...
/// Recore operation result type
pub type RecoreResult<T> = std::result::Result<T, RecoreError>;

// to maintain backward compatibility, re-export the original name
pub use RecoreError as ProxyError;
pub use RecoreResult as Result;
