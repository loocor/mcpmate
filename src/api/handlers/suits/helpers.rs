...
pub async fn get_suit_or_error(db: &Database, suit_id: &str) -> Result<ConfigSuit, ApiError> {
...
pub async fn get_server_or_error(db: &Database, server_id: &str) -> Result<Server, ApiError> {
...
pub async fn get_tool_or_error(db: &Database, tool_id: &str) -> Result<ConfigSuitTool, ApiError> {
...
pub fn check_tool_belongs_to_suit(tool: &ConfigSuitTool, suit_id: &str) -> Result<(), ApiError> {
